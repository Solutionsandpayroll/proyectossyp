...
Construye una interfaz web de dashboard administrativo corporativo en español, estilo S&P Gestión, con layout de sidebar fija izquierda y main content con header sticky. Usa una estética clara y profesional con alto contraste y legibilidad.
...
- Visualización de datos: módulo de ahorro con cards ejecutado/proyectado, barra de avance y gráfico radial tipo anillos con gradiente.
...
## 11) Fuentes de referencia internas

Este brief fue sintetizado desde las pantallas actuales del proyecto:
- index.html
- login.html
- proyectos.html
- tickets.html
